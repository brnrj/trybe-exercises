...
// const xablau = ({ lastName }) => `O Flamengo é top ${lastName}`;
...
// console.log(getUser(xablau));
// assert.strictEqual(getUser(), 'Hello! My name is Ivan Ivanovich'); // complete a chamada da função de getUser
// assert.strictEqual(getUser(), 'Ivan is Russian'); // complete a chamada da função de getUsers
